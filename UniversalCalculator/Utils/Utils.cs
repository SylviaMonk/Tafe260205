...
namespace Calculator.Utils
{
	public static class Utils
	{
		...
		{
			TextBlock primaryDisplay = Calculator.calculator.primaryDisplay;
			TextBlock secondaryDisplay = Calculator.calculator.secondaryDisplay;
			TextBlock errorDisplay = Calculator.calculator.errorDisplay;
		...
		{
			Calculator.calculator.primaryDisplay.Text = "";
			Calculator.calculator.secondaryDisplay.Text = "";
		}
